    ...
    return (
      <div className="c7n-iam-dashboard-document">
        <ul>
          ...
          <li>
            <a target="choerodon" href="http://choerodon.io/zh/docs/quick-start/microservice-front/">创建一个前端应用</a>
          </li>
          <li>
            <a target="choerodon" href="http://choerodon.io/zh/docs/quick-start/microservice-backend/">创建一个后端应用</a>
          </li>
          <li>
            <a target="choerodon" href="http://choerodon.io/zh/docs/quick-start/agile/">使用敏捷管理工具</a>
          </li>
        </ul>
        <DashBoardNavBar>
